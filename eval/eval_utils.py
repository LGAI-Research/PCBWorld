...
# ============================================================================
#
# These shared field lists are the pcbworld eval wire protocol. Value metrics
# are declared once and reused by per-rollout rows, per-board rows, overall
# aggregation, and TensorBoard/W&B emission. Adding a pcbworld metric means
# updating PCBWORLD_VALUE_METRIC_FIELDS first.
...
PCBWORLD_VALUE_METRIC_FIELDS: tuple[str, ...] = (
...
PCBWORLD_BOOL_VALUE_METRIC_FIELDS: frozenset[str] = frozenset({
    "terminated", "truncated", "crashed", "engine_crash",
...
PER_BOARD_METRIC_FIELDS: tuple[str, ...] = PCBWORLD_VALUE_METRIC_FIELDS
