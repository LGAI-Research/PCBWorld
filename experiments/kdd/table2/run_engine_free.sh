...
#     API_PROVIDER, API_MODEL          — model alias config (experiments/kdd/configs/quickstart/models.json)
#     SYNTH_2L_TEST_DIR / REAL_BOARD_DIR — split alias  (experiments/kdd/configs/quickstart/splits.json)
#     OUT_ROOT                          — --out
...
#
# Flags:
#   --model <alias>           (required)  experiments/kdd/configs/quickstart/models.json
#   --split <alias>           (required)  d2a | d3a (experiments/kdd/configs/quickstart/splits.json; legacy t2/t3a accepted)
...
from configs.loader.paths import expand_data_path  # ${PCBWORLD_DATA_ROOT} entries
