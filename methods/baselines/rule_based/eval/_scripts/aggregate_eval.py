#!/usr/bin/env python3
"""Generalized aggregator for pcbworld eval.metrics outputs.
...
python aggregate_eval.py --eval-root .../pcbworld/eval --dataset synth_2L_v2_test \\
    --method-filter '^freerouting_via1x$' --mode single

# Transformer_PPO on PCBench (40 algo dirs, max-Φ rollout per seed)
python aggregate_eval.py --eval-root .../pcbworld/eval --dataset PCBench \\
