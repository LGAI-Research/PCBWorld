...
# ({rejected_attempts}) on CADAGENT_USER_PROMPT and CADAGENT_TEMPLATE. All
# str.format() callers must pass it (env_manager + the cadagent rollout updated).
