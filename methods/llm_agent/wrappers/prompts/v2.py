# --------------------- PCBWorld V2 (KiCad PCB Routing) --------------------- #
#
# V2 augmentations over V1 (pcbworld.py):
...
#
# Interface-compatible with V1 (drop-in via PCBWORLD_PROMPT_VERSION=v2 switch
# in pcbworld.py). All exported names match V1. PCBWORLD_USER_PROMPT keeps the
# wschoi-branch history format `{current_step} / {valid_step_count}` to match
# rollout/pcbworld.py and env_manager.py callers.
# -----------------------------------------------------------------------------
