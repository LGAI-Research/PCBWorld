...
#
# Interface-compatible with V1/V2/V3 (drop-in via PCBWORLD_PROMPT_VERSION=v4
# in pcbworld.py). Exported names match V1. PCBWORLD_USER_PROMPT uses the
...
# (matches .format() kwargs in rollout/pcbworld.py and env_manager.py).
